<!--Kode ini berfungsi mengatur tata letak halaman untuk manajemen jabatan, termasuk tautan menu, daftar jabatan dalam tabel, dan formulir untuk 
menambah jabatan baru dengan menggunakan PHP dan MySQL.-->

<!-- Container untuk mengatur layout -->
<div class="container-fluid">
    <!-- Baris untuk menempatkan elemen-elemen -->
    <div class="row">
        <?php
                    ...
                    <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered modal-sm" role="document">
                        <div class="modal-content">
                            ...
                            <form action="fungsi/tambah.php?jabatan=tambah" method="post">
                                ...
                                <!-- Tombol untuk menutup dan menyimpan form -->
